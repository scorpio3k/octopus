...
public class ObjectUtils {
    ...
    //-----------------------------------------------------------------------
    /**
     * 如果<code>object==null</code>则返回defaultValue,否则返回object。
    ...
    /**
     * 判断两个对象是否相等,如果两个对象都为<code>null</code>则返回<code>true</code>。
    ...
    /**
     * 判断两个对象是否不相等,如果两个对象都为<code>null</code>则返回<code>false</code>。
    ...
    /**
     * 获取对象的hash code，如果对象为<code>null</code>,则返回0。
    ...
    //-----------------------------------------------------------------------
    /**
     * 获取 {@link Object#toString()}方法打印的内容,null值会返回null。
    ...
    //-----------------------------------------------------------------------
    /**
     * 获取toString的内容,如果<code>obj==null</code>则返回""。
    ...
    /**
     * 获取toString的内容,如果<code>obj==null</code>则返回nullStr。
     * <p>Gets the <code>toString</code> of an <code>Object</code> returning
     ...
     * @param c1  the first comparable, may be null
     * @param c2  the second comparable, may be null
     * @param nullGreater 如果设置为true，则 <code>null</code>值比 非<code>null</code>值大，
     * 如果设置为 false 则<code>null</code>值比 非<code>null</code>值小，
     * @return a negative value if c1 < c2, zero if c1 = c2
     * and a positive value if c1 > c2
