...
/**
 * 数组工具类，提供插入删除元素、翻转、类型转换等针对数组的操作。
 * 
...
public class ArrayUtils {
    ...
    //-----------------------------------------------------------------------
    /**
     * 将数组转换为<code>Map</code>。
     * 数组中的每个元素都必须是{@link java.util.Map.Entry}或者是至少含有两个元素的数组，
     * 第一个元素作为key,第二个元素作为value。
    ...
    //-----------------------------------------------------------------------
    /**
     * 浅克隆数组并返回类型转换的结果，输入<code>null</code>将返回<code>null</code>。
    ...
    //-----------------------------------------------------------------------
    /**
     * 如果<code>array==null</code>或者<code>array.length==0</code>,
     * 将返回一个没有任何元素的数组，否则返回本身。
    ...
    /**
     * 返回数组中指定元素的索引。
     * 如果<code>array==null</code>或者找不到指定元素将返回-1.
    ...
    /**
     * 将包装类数组转换为基本数据类型的数组，如果数组中元素为<code>null</code>,则用valueForNull填充。
    ...
    // ----------------------------------------------------------------------
    /**
     * 如果<code>array==null</code>或者<code>array.length==0</code>,返回true。
    ...
    /**
     * 返回一个原数组的拷贝，但长度比原数组增加了一位，最后一个元素的值是默认的。
     * 如果<code>array==null</code>，则按照指定的新类型创建数组，数组长度比原数组增加一位。
    ...
    public static boolean[] add(boolean[] array, int index, boolean element) {
        return (boolean[]) add(array, index, toBooleanObject(element), Boolean.TYPE);
    }
    /**
     * 将boolean类型转换为相应的包装类。
